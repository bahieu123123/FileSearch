...
public class FileSearchTest {
    ...
    public void search() {
        ...
        String f4 = new File("input/dir/dir0/dir0").getAbsoluteFile().toString();
        String f5 = new File("input/dir/dir2/dir0").getAbsoluteFile().toString();
        FS3.search("dir0", new File("input/dir"), true);
